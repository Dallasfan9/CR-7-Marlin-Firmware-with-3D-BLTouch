...
#define STRING_CONFIG_H_AUTHOR "(AWM, CR-7)" // Who made the changes.
...
#define SHOW_CUSTOM_BOOTSCREEN      //AWM - For Creality Bootscreen

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
#define CUSTOM_STATUS_SCREEN_IMAGE      //AWM - For Creality Statusscreen

// @section machine

// Choose the name from boards.h that matches your setup
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V427       //AWM
#endif
...
#define CUSTOM_MACHINE_NAME "Adam's CR-7 4.2.7"     //AWM
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU           // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)       //AWM
  #define PID_AUTOTUNE_MENU       // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)       //AWM
#endif
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.        //AWM - BLTouch
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN        //AWM - Enabled for dedicated BLTouch Port

// Force the use of the probe for Z-axis homing
// #define USE_PROBE_FOR_Z_HOMING        //AWM - Enabled for dedicated BLTouch Port
 ...
 */
//#define FIX_MOUNTED_PROBE       //AWM - Not needed for the BLTouch
 ...
 */
#define BLTOUCH       //AWM - Enable BLTouch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -9, 0 }       //AWM - Ender-3 Offset - starting point for CR-7
...
#define INVERT_X_DIR true       //AWM - Needed for CR-7 [Printer motor wired in reverse]
...
#define X_BED_SIZE 130        //AWM - CR-7
#define Y_BED_SIZE 130        //AWM - CR-7
 ...
 */
//#define AUTO_BED_LEVELING_3POINT        //AWM - Use with BLTouch if bed has no warps
//#define AUTO_BED_LEVELING_LINEAR        //AWM - Use with BLTouch if bed has no warps
#define AUTO_BED_LEVELING_BILINEAR        //AWM - Use with BLTouch if bed has warps
//#define AUTO_BED_LEVELING_UBL       //AWM - Advanced method MESH - TODO
 ...
 */
#define RESTORE_LEVELING_AFTER_G28        //AWM - Restore leveling informations
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  // #define G26_MESH_VALIDATION       //AWM - Need to define NOZZLE_SIZE, LAYER_HEIGHT and HOTEND_TEMP below
  ...
  #define GRID_MAX_POINTS_X 4       //AWM
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID       //AWM - Continue the implied tilt TESTING

    //
    // Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION        //AWM
    #if ENABLED(ABL_BILINEAR_SUBDIVISION)
      // Number of subdivisions between probe points
      #define BILINEAR_SUBDIVISIONS 4       //AWM
    #endif
 ...
 */
#define LCD_BED_LEVELING        //AWM - BLTouch LCD options
...
// #define LCD_BED_TRAMMING        //AWM

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 30, 30 } // (mm) Left, Front, Right, Back insets        //AWM - Probe must be able to reach points
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between tramming points        //AWM 
  #define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner       //AWM
  #define BED_TRAMMING_USE_PROBE        //AWM
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.1  // (mm)
    #define BED_TRAMMING_VERIFY_RAISED        // After adjustment triggers the probe, re-probe to verify
    #define BED_TRAMMING_AUDIO_FEEDBACK       //AWM
  #endif
 ...
 */
#define Z_SAFE_HOMING       // AWM - X and Y homing before Z homing
 ...
 */
#define NOZZLE_PARK_FEATURE       //AWM
 ...
 * :[0:'Classic', 1:'Průša']
 */
#define LCD_INFO_SCREEN_STYLE 0       //AWM - TESTING
 ...
 */
#define SDSUPPORT       //AWM - Enable print from SD card
...
#define INDIVIDUAL_AXIS_HOMING_SUBMENU        //AWM
...
//
#define CR10_STOCKDISPLAY       //AWM - Creality screens
